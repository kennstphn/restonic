...
<div id="k2Container" class="container-fluid itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading" class="row-fluid">
			...
			<div class="span12 itemContainer<?php echo $lastContainer; ?>"<?php echo (count($this->leading)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('num_leading_columns'), 1).'%;"'; ?>>
				<?php
		...
		<div id="itemListPrimary" class="row-fluid">
			...
			<div class="span6 itemContainer<?php echo $lastContainer; ?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
